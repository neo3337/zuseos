"""
zuseos.py
A Generalized Artificial Intelligence algorithm created to supersede Artificial Neural Networks

Cognitive artificial intelligence, polymorphic artificial intelligence, memory predictor

Myth of Er, trou de rev, death false
