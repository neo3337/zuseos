...
CHUNK_SIZE = 1 #Split the text to N chunks. Larger chunking leads to more coherent but less creative text, as well as longer outputs, it's the memory.
...
def loadWeights():
    ...
    for v in graph:
        ...
        for v2 in graph[v]:
            ...
            weight[tuple([v, v2])] = graph[v].count(v2)-ShannonEntropy(v2)*ENTROPY_WEIGHT
